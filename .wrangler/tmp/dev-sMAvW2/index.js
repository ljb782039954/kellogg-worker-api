...
// .wrangler/tmp/bundle-MN6nWj/strip-cf-connecting-ip-header.js
...
// src/kvData/pages/pages_index.json
var pages_index_default = [
  ...
  },
  {
    ...
    path: "/service",
    title: {
      zh: "Sample / Clothing Development",
      en: "Sample / Clothing Development"
    },
    isFixed: false,
    type: "dynamic-block",
  ...
  {
    id: "page_3nH4BuZ2",
    path: "/heavyweight-hoodie",
    title: {
      zh: "Heavyweight Hoodie",
      en: "Heavyweight Hoodie"
    },
    isFixed: false,
    type: "dynamic-block"
  }
...
// src/kvData/pages/page_home.json
  ...
  blocks: [
    {
      ...
      content: {
        ...
        items: [
          ...
          {
            id: 2,
            image: "https://assets.kelloggfashion.com/uploads/china-heavyweight-garment-factory_-7_Zh7pj3kT5rR6RTo2.jpg",
            title: {
          ...
          {
            id: 3,
            image: "https://assets.kelloggfashion.com/uploads/china-heavyweight-garment-factory_-8_ZOR9rhuVMJLpeOjD.jpg",
            title: {
...
// src/kvData/pages/page_about.json
...
// src/kvData/pages/page_faq.json
...
// src/kvData/pages/page_products.json
...
// src/kvData/pages/page_system-inquiry.json
...
// src/kvData/pages/page_system-blog.json
...
// src/kvData/pages/page_customer-reviews.json
var page_customer_reviews_default = {
  id: "customer-reviews",
  ...
  seo: {
    title: {
      zh: "\u5BA2\u6237\u8BC4\u4EF7 - Kellogg Fashion",
      en: "Customer Reviews - Kellogg Fashion"
    },
    description: {
    ...
    keywords: {
      zh: "\u5BA2\u6237\u8BC4\u4EF7,\u53CD\u9988,\u91CD\u78C5\u536B\u8863\u8BC4\u4EF7,\u670D\u88C5\u5B9A\u5236\u53CD\u9988",
      en: "customer reviews,client testimonials,heavyweight hoodie review,custom apparel feedback"
    },
    targetCountry: "United States, United Kingdom, Australia, Canada"
  },
  blocks: []
...
async function initKV(request, env) {
  ...
  try {
    ...
    await env.KELLOGG_FRONTEND_CONFIG.put("page:customer-reviews", JSON.stringify(page_customer_reviews_default));
...
__name(transformReview, "transformReview");
...
async function updateReview(request, env, id) {
  ...
  if (!existing)
    return errorResponse(`\u8BC4\u4EF7 ID ${id} \u4E0D\u5B58\u5728`, env, 404);
  const input = await request.json();
  const updates = [];
  const params = [];
  const fieldMap = {
...
// .wrangler/tmp/bundle-MN6nWj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MN6nWj/middleware-loader.entry.ts
